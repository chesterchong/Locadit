...
export const PIECES: Piece[] = [
  ...
  { id: "sun", layer: 2, kind: "emoji", content: "🌻", x: 800, y: 380, size: 440, z: 5, to: { x: 150, y: 560, size: 270, rot: -15 } },
  ...
  { id: "city", layer: 2, kind: "emoji", content: "🏙️", x: 1470, y: 560, size: 320 },
  { id: "lantern", layer: 2, kind: "emoji", content: "🏮", x: 1520, y: 400, size: 140, rot: 10 },

  // Layer 3 · objects and people (rounded wordmark)
  { id: "phone", layer: 3, kind: "emoji", content: "☎️", x: 450, y: 330, size: 170, rot: -18, to: { x: 420, y: 330 } },
  { id: "octo", layer: 3, kind: "emoji", content: "🐙", x: 1090, y: 640, size: 210, rot: 15 },
  { id: "book", layer: 3, kind: "emoji", content: "📙", x: 1350, y: 720, size: 230, rot: 14 },
  { id: "portrait", layer: 3, kind: "emoji", content: "🧑‍🎤", x: 150, y: 640, size: 230, rot: -5 },
  { id: "opera", layer: 3, kind: "emoji", content: "🏛️", x: 1510, y: 660, size: 270 },
  ...
  { id: "balloon", layer: 4, kind: "emoji", content: "🎈", x: 1420, y: 300, size: 120, rot: 5 },
  { id: "tape", layer: 4, kind: "emoji", content: "📼", x: 720, y: 520, size: 170, rot: -12, hideAtEnd: true },
  { id: "camera", layer: 4, kind: "emoji", content: "📷", x: 1480, y: 400, size: 150, rot: -15, to: { x: 1540, y: 420 } },
  ...
  { id: "disco", layer: 5, kind: "emoji", content: "🪩", x: 90, y: 180, size: 130 },
  { id: "pol-a", layer: 5, kind: "polaroid", x: 380, y: 360, size: 90, h: 150, rot: 12, color: "linear-gradient(160deg,#5b7cfa,#1b2a7a)" },
  { id: "pol-b", layer: 5, kind: "polaroid", x: 470, y: 290, size: 96, h: 160, rot: -8, color: "linear-gradient(160deg,#ffb36b,#ff5e8a)" },
  { id: "pol-c", layer: 5, kind: "polaroid", x: 560, y: 330, size: 80, h: 130, rot: 18, color: "linear-gradient(160deg,#7ee0c2,#1d8a6b)" },
  { id: "daisy", layer: 5, kind: "emoji", content: "🌼", x: 460, y: 870, size: 80 },
  { id: "alien", layer: 5, kind: "emoji", content: "👾", x: 1290, y: 880, size: 120 },
  { id: "wheel", layer: 5, kind: "emoji", content: "🎡", x: 1580, y: 520, size: 200 },
